...
const BrowseVenueOutput = z
  .object({ data: z.array(Venue), total_count: z.number().int() })
  .passthrough();
...
const BrowseReservationOutput = z
  .object({ data: z.array(Reservation), total_count: z.number().int() })
  .passthrough();
...
const ViewMyReservationOutput = z
  .object({ data: z.array(ViewMyReservation), total_count: z.number().int() })
  .passthrough();
