...
export default function Manage() {
  ...
  const { refetch: refetchVenues } = useLessorBrowseVenue({ limit: 10, offset: 0 });
  const { refetch: refetchStadiums } = useLessorBrowseStadium({ limit: 10, offset: 0 });
  const { refetch: refetchCourts } = useLessorBrowseCourt({ limit: 10, offset: 0 });
